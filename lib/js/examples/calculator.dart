            ...
            switch ($action.action as int) {
                ...
                case 2:
                    ...
                    if (options['ranges'] == true) {
                        //TODO: add ranges
                        throw  UnimplementedError('Not supported in dart version');
                    }
    ...
    void reject() {
        ...
        if (options['backtrack_lexer'] == true) {
            ...
            'is of the backtracking persuasion (options.backtrack_lexer = true).\n'
                + showPosition(),  LexerError('', -1, yy.lineNo));
        }
    }
                ...
                backup.forEach((k, v) {
                    switch (k) {
                        ...
                        case 'done':
                            ...
                            break;
                        default:
                            throw  UnsupportedError('Key is unknown [$k]');
                    }
                });
